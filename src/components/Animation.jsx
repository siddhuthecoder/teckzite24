...
const Animation = (props) => {
  ...
  <h1 className="absolute text-[40px] font-bruno md:text-[60px] translate-x-[-50%] translate-y-[-50%] text-white stroke-[2px] stroke-[#05a8f3]">
    {props.title}
  </h1>
  <h1 className="absolute text-[40px] font-bruno md:text-[60px] translate-x-[-50%] translate-y-[-50%] text-[#05a8f3] stroke-[2px] stroke-[#05a8f3] animate-waves">
    {props.title}
  </h1>
</div>
