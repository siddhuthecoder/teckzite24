  ...
  return (
    ...
    >
      <img
        ...
        width="100%"
        alt="siddu"
        className={`hover: saturate-[1] overflow-hidden [clip-path:polygon(38%_5%,_10%_5%,_0_13%,_0%_80%,_7%_87%,_7%_100%,_85%_100%,_100%_85%,_100%_30%,_95%_25%,_95%_0,_45%_0)] w-[200px] h-[300px] `}
        style={{
