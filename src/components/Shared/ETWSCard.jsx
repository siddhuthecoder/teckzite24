...
const ETWSCard = ({ about, name, img, id }) => {
  ...
  return (
    ...
    >
      ...
      />
      <div
        className={`absolute top-0 opacity-50    [clip-path:polygon(38%_5%,_10%_5%,_0_13%,_0%_80%,_7%_87%,_7%_100%,_85%_100%,_100%_85%,_100%_30%,_95%_25%,_95%_0,_45%_0)] min-w-[260px] h-[350px] z-[2] bg-[black] duration-100 ${isHover ? "" : ""
          }`}
      ></div>
      <motion.div className="absolute bottom-[20px] w-full z-[3]">
        <div
          className={`${isHover ? "text-[22px]" : "text-[20px]"
