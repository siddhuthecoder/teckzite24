    ...
    <main>
      ...
      <div className="w-full flex flex-col z-10 min-h-[85vh] mb-5 sticky  ">
        <div className="w-full flex items-center justify-center flex-wrap mt-3  ">
          ...
          <button
            className={`tab  w-[100px] h-[30px] rounded-sm mx-[10px] mt-[12px] ${
              tab === "CSE" ? "gradient-bg" : ""
            }`}
            onClick={() => {
              setTab("CSE");
        ...
        <div className="w-full">
          <>
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-24">
              <div className="grid grid-cols-1 place-content-center place-items-center md:grid-cols-2 lg:grid-cols-3 gap-4">
                {filteredEvents ? (
                  <EWCard />
                ) : (
                  <div role="status">
