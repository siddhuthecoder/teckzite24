  ...
  return (
    <section className="absolute top-0 w-[99vw] m-auto overflow-x-hidden">
      ...
      <div className="w-[85%] mt-[20px] m-auto">
        <div className="w-full text-center justify-between px-[3%] items-center py-[15px] flex bg-[rgb(152,65,255)] [clip-path:polygon(50%_0%,_97%_0,_100%_50%,_97%_100%,_3%_100%,_0_50%,_3%_0)]">
