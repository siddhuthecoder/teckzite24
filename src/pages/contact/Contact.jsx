  ...
  return (
    <section className="absolute top-0 bg-black w-[99vw] m-auto overflow-x-hidden">
      ...
      {size[0] <= 1204 ? (
        <>
          {/* laptop */}
          <div className=" bg-[#0f1214] backdrop-blur-lg lg:pt-[8%] pb-[30px] pt-[50px] h-screen flex items-center justify-center w-full lg:[clip-path:polygon(25%_0,_0_0,_0_100%,_25%_100%,_35%_95%,_65%_95%,_78%_100%,_100%_100%,_100%_0,_75%_0,_65%_5%,_35%_5%)]">
        ...
        <>
          <div className="flex justify-center">
            ...
            <div className="w-1/2  rotate-180 items-center justify-center bg-[#0f1214]  backdrop-blur-lg [clip-path:polygon(32%_10%,_46%_0,_100%_0,_100%_100%,_45%_100%,_32%_90%,_0_90%,_0_10%)]">
              <div className="w-[90%] rotate-180 h-[85%]">
                ...
                <div className="w-full flex flex-col">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-1 ">
                    <div className="flex items-center  w-full relative h-[70px] ">
                      <textarea className="w-[85%] mx-auto border-none outline-none bg-transparent z-[2]"></textarea>
                      <img
                        src={text}
                        alt=""
                        className="absolute scale-x-[1.45] left-0 ms-[-20px]  w-full"
                        style={{ width: "100%", height: "100%" }}
                      />
                    </div>
                  </div>
            ...
            {/* Right Card */}
            <div className="w-1/2 bg-[#0f1214]  backdrop-blur-lg cursor-default [clip-path:polygon(32%_10%,_46%_0,_100%_0,_100%_100%,_45%_100%,_32%_90%,_0_90%,_0_10%)]">
