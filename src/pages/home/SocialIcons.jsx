    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col w-[100%]">
          <motion.div
            className="text-center font-bold py-[20px]  text-2xl"
          ...
          <motion.div
            className="text-center font-bold text-[40px] md:text-[80px] grad-text"
            initial={{ y: 100, opacity: 0, scale: 1 }}
            animate={{ y: 0, opacity: 1, scale: 1 }}
            exit={{ opacity: 0 }}
            transition={{ duration: 0.5, type: "spring", stiffness: 100 }}
          ...
          <div
            className="w-full mt-[30px] flex items-center gap-5  justify-center flex-wrap max-h-[90vh]"
            style={{ overflowY: "" }}
          >
            {icons.map((data, index) => (
              <motion.div
                ...
                className="icon-bg  mx-[20px] bg-[#0a0b0f] z-1 w-[150px] h-[150px]  m-[20px] border-[#A301B1] rounded-[4px] border relative flex items-center justify-center flex-col"
                style={{
                  backgroundImage:
              ...
              >
                ...
                <div
                  className="link-font grad-text text-2xl text-[#a301b1] font-bold"
                  style={{}}
                >
                  {data.name}
                </div>
