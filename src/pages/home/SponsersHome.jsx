...
const SponsersHome = () => {
  return (
    <motion.section
      className=" relative w-full min-h-[100vh]   flex-col flex  justify-between z-[5]"
      style={{
        position: "sticky",
        top: "0px",
        left: "0px",
    ...
    >
      <Header />
      <SideComonent text="SPONSERS" num="5" />
      <div className="w-full flex flex-col h-[90vh] items-center justify-start overflow-y-scroll  gap-5 mt-[4%] ">
        ...
        <div className="w-full pb-12 flex items-center justify-center flex-wrap">
          <SponsorsCard2 />
          <SponsorsCard2 />
          <SponsorsCard2 />
        </div>
