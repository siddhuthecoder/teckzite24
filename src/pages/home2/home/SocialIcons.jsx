        ...
        <>
            ...
            <motion.section
                ...
                <div className="flex flex-col w-[100%]">
                    <motion.div className="text-center font-bold py-[20px]  text-4xl"
                    ...
                    <motion.div className="text-center font-bold md:text-5xl sm:text:4xl text-2xl grad-text"
                        initial={{ y: 100, opacity: 0, scale: 1 }}
                        animate={{ y: 0, opacity: 1, scale: 1 }}
                        exit={{ opacity: 0 }}
                        transition={{ duration: 0.5, type: 'spring', stiffness: 100 }}
                    ...
                    <div className="w-full mt-[30px] flex items-center gap-5  justify-center flex-wrap max-h-[90vh]" style={{ overflowY: "" }} >
                        {icons.map((data, index) => (
                            <motion.div
                                ...
                                <span className="text-7xl soc-icon">{data.icon}</span>
